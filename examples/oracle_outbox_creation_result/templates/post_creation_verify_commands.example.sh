...
echo "No sample signal file is created. No systemd operations. No orders. order_execution_allowed=false."
...
echo "Do not run touch, sample signal writes, systemctl, or trading scripts in this check."
